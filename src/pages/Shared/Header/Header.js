...
const Header = () => {
    return (
        <div className='border-slate-900 '>
            <header className="p-4  dark:text-white-800 blur-none">
                <div className="container flex justify-between h-16 mx-auto">
                    <ul className="items-stretch hidden space-x-3 lg:flex">
                        <li className="flex">
                            <Link to='/home' className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent text-amber-50  dark:border-violet-400 font-semibold">Home</Link>
                        </li>
                        <li className="flex">
                            <Link className=" font-semibold text-amber-50 flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Booking</Link>
                        </li>
                        <li className="flex">
